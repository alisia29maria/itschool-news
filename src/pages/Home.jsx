...
function Home() {
  ...
  return (
    <Layout>
      ...
      <section className="law my-5">
        <Container>
          <h1 className="mb-5 pt-3">Law</h1>
          <NewsCardList newsList={adaptedLawData} />
          <p>
            Vezi toate știrile legate de justiție în secțiunea{" "}
            <Link to="/category/law" className="text-secondary">
              Law
            </Link>
            .
          </p>
